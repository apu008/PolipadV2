...
<input name="caption" type="text" class="input1" onkeyup="javascript:txtCounters('txtCounter1',70,'caption')" maxlength="70" id="caption" value="<?=$caption?>" size="92" style="float:left;"  />
                       ...
                       <?
								...
								{
							?>
                            		<div class="block-margin"><a href="<? echo site_url('welcome/index/'.$cam_id);?>" class="button20" style="display: block; margin-left: auto; margin-right: auto;">Log-in to add an idea</a></div>
                            <?	
								}
							?> 
            ...
            <div class="col-3-4">
                ...
                <div class="block05">
                	  <div class="block-padding">
                     <a href="<? echo site_url('campaign/add_idea');?>"> <img src="<?=base_url();?>images/conid.jpg" class="displayedi" /></a>
                      </div>
                </div>
                <?
					 }
