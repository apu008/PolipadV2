...
onKeyUp="limitText(this.form.comments,this.form.commentscountdown,250);"></textarea><?=form_error('comments');?>
 ...
 <?
							...
							?>
                             <div class="block-margin">
                            		<a href="<? echo site_url('welcome/index/'.$cam_id);?>" class="button2" style="display: block; margin-left: auto; margin-right: auto;">Login for post your feedback</a>
                                    </div>
                            <?	
								}
							?>
				...
				?>
                  <div class="block05">
                     <div class="inner-block">
                              <div class="block-padding">
                            <span style="font-size: 24px; line-height: 40px;font-weight:normal;">List of Supporters</span></div>
						<?
