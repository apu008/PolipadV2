...
?>
<?= form_open_multipart('campaign_edit/ideas',$attributes);?>
              ...
              <div class="borderdiv">
                ...
                <a href="<? echo site_url('campaign_edit/events');?>"><ol class="mainnevg">Events</ol></a>
                      ...
                      <span class="normaltitle">Idea Title</span> &nbsp;&nbsp;<span id="txtCounter" style="font-size:12px; color:#666666">(0/60)</span>:<?=form_error('idea_title');?>
                        ...
                        <input name="idea_title" id="idea_title" type="text" class="input1" onkeyup="javascript:txtCounters('txtCounter',60,'idea_title')" maxlength="60" value="<?=$idea_title?>"  />
                        </div>
                        <div class="block-margin">
...
<input name="caption" type="text" class="input1" onkeyup="javascript:txtCounters('txtCounter1',70,'caption')" maxlength="70" id="caption" value="<?=$caption?>" size="92" style="float:left;"  />
						...
						?>
                            ...
                            <div style="background:#002060; height:60px;"><h1 style="text-align:center; padding-top:8px; color:#FFC000;"><?=$good->num_rows()?></h1>
                            </div>
                            <div style="background:#FFC000; height:60px;"><h1 style="text-align:center; padding-top:8px; color:#002060;"><?=$not_bad->num_rows()?></h1></div>
                            </div>
                            <div style="width:89%; float:left; margin-left:2%">
                            <a href="<? echo site_url('campaign_edit/idea_view/'.$row['id']);?>" class="mediamlink"><?=$row['idea_title']?></a>
                            <?
							if($this->candidate_model->is_idea_this_can($this->session->userdata('user_id'),$row['id']))
							{
							?>
                            <span class="mediamlink">&nbsp;|&nbsp;</span><a href="<? echo site_url('campaign_edit/idea_edit/'.$row['id']);?>" class="mediamlink">Edit</a>
                            <?
							}
							...
							<?=substr($row['details'],0,140);?> ... <a href="<? echo site_url('campaign_edit/idea_view/'.$row['id']);?>" class="mediamlink">More</a>
