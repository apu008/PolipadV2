...
<section>
    ...
    <?= form_open_multipart('candidate/previewShare');?>
            <div class="col-full">
                <div class="block03"> 
                	<img src="<?=base_url();?>images/fol.png" class="img-stylep" />
                    <h3 style="color:#999">Hello, you are about to share this campaign!</h3><br /><br /><br />
                  <span  style="color:#09F;">Add e-mail address below. For multiple e-mails, please separate by comma:</span><br />
<input name="shareemails" type="text" class="input1" id="shareemails" value="<?=$shareemails?>"  /><?=form_error('shareemails');?><br /><br />

<span  style="color:#09F;">Message below will be sent with the link. Feel free to edit before sharing:</span><br />
<textarea name="share_com" rows="8" class="textarea3" id="share_com">
Hello, I had been working on this campaign and would like to share:<br />
<a href="<? echo site_url('sharecampaign/main/'.$cam_id);?>" class="normallink"><?=$cbrow['cam_title']?></a>
<br /><br />
Please check out, support the campaign, give me a idea to make things better, or just plain feedback.<br />
<br />
Thanks in advance,<br />
<?=$this->session->userdata('name')?>

</textarea><?=form_error('share_com');?>
 ...
 <div class="wrap-content affangrid">
            <div class="col-full">
                <div class="block03"> 
                <input type="image" src="<?=base_url();?>images/share.png" value="      " name="SaveProject"  class="img-style3" />
                  
                   <a href="<? echo site_url('candidate/preview');?>"><img src="<?=base_url();?>images/cancel.png" class="img-style3" /></a>
