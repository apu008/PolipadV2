...
<div class="wrap-content affangrid">
        ...
        <div class="col-full">
				<div>
                      ...
                      <img src="<?=base_url();?>images/flower.png" width="32" height="27"><br /><br />


                			<div style="line-height:28px; font-size:16px;">
                          We have sent you an email with your current password.  If you don't find it in your main Inbox, please also check your spam folder to make sure it did not go there.<br />
 If there is anything else we can help you with feel free to Contact us at: <span class="normallink"><u>campaign@polipad.net</u></span>.
