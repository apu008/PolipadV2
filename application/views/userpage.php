<section id="content">
	<div class="wrap-content affangrid">
		<div class="row block" style="margin-bottom:10px;">
        	<div class="col-full">
				<div class="block01">
						<h1 style="color:#333333;">Dashboard for <?=$uname?></h1>

                </div>
                <div class="block01" style="margin-top:10px;">
						 <div style="width:9%; height:auto; float:left;">	
                        <?
							$post_user = $this->user_model->get_info($user_id);
							$purow = $post_user->row_array();

								if($photo !=''){ $sobi = $photo; } else {$sobi = 'user.jpg';}
							?>
					...
					if($pcam->num_rows() > 0)
					{
						?>
                         <div class="row blockmypage">
							<div class="col-full">
                        		<div class="block01">
                         <h2 style="color:#666666;">Public Campaigns you have launched:</h2>
...
Total Number of Interactions: <?=$totideas->num_rows()+$totcom->num_rows()+$totsup->num_rows();?>
            ...
            <?
					if($scam->num_rows() > 0)
					{
						...
						<div class="col-full">
                        <div class="block01">
                         <h2 style="color:#666666;">Campaigns you have submited for Approval:</h2>
...
$bad = $this->candidate_model->get_cam_sup_vote($row['id'],'I would support the campaign, if it addressed the following');
					?>
                   <div style="margin-top:10px;">
                   <h4><a href="<? echo site_url('candidate/preview/'.$row['id']);?>" style="color:#000000; font-weight:bold; text-decoration:none;"><?=$row['cam_title']?></a></h4>
                   </div>
                   <?
                   if($cb->num_rows() > 0)
					{
                  ...
                  <?
				   ...
				   ?> 
					...
					if($pvcam->num_rows() > 0)
					{
						...
						<div class="col-full">
                        <div class="block01">
                         <h2 style="color:#666666;">Private Campaigns you have launched:</h2>
...
$bad = $this->candidate_model->get_cam_sup_vote($row['id'],'I would support the campaign, if it addressed the following');
					?>
                   <div style="margin-top:10px;">
                   <h4><a href="<? echo site_url('candidate/preview/'.$row['id']);?>" style="color:#000000; font-weight:bold; text-decoration:none;"><?=$row['cam_title']?></a></h4></div>
                   <?
                   if($cb->num_rows() > 0)
					{
						$cbrow = $cb->row_array();
...
Total Number of Interactions: <?=$totideas->num_rows()+$totcom->num_rows()+$totsup->num_rows();?>
				...
				<div class="col-full">
                        <div class="block01">
                         <h2 style="color:#666666;">Campaign page(s) under construction:</h2>
				...
				<div class="col-full">
                        <div class="block01" style="margin-bottom:10px;">
                         <h2 style="color:#666666;">Upcoming events hosted by you:</h2>
				...
				<div class="col-full">
                         <div class="block01" style="margin-bottom:10px;">
                         <h2 style="color:#666666;">Upcoming events you wanted to join:</h2>
...
if(mysql_num_rows($sup)>0){
				...
				<div class="col-full">
                        <div class="block01">
                         <h2 style="color:#666666;">Campaign(s) you are supporting and like to help out:</h2>
       ...
       <?
			...
			if(mysql_num_rows($sup)>0){
				...
				<div class="col-full">
                        <div class="block01">
                         <h2 style="color:#666666;">Campaign(s) you are supporting:</h2>
...
if(mysql_num_rows($sup)>0){
				...
				<div class="col-full">
                        <div class="block01">
                         <h2 style="color:#666666;">Campaign(s) you would support if...:</h2>
...
if(mysql_num_rows($ide)>0){
				...
				<div class="col-full">
                        <div class="block01">
                         <h2 style="color:#666666;">Idea(s) you have developed:</h2>
...
if(mysql_num_rows($iicom)>0){
				...
				<div class="col-full">
                        <div class="block01">
                         <h2 style="color:#666666;">You voted on following ideas as good and practical:</h2>
...
if(mysql_num_rows($iicom)>0){
				...
				<div class="col-full">
                        <div class="block01">
                         <h2 style="color:#666666;">You voted on following ideas as not practical:</h2>
...
if(mysql_num_rows($iicom)>0){
				...
				<div class="col-full">
                        <div class="block01">
                         <h2 style="color:#666666;">You have left comments on following idea(s):</h2>
