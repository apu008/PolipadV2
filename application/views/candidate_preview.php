...
<section>
	<div class="row">
     		 	<?
				if(($row['status'] == 1) or ($row['status'] == 2) or ($row['status'] == 3)){
				?>
     <div class="wrap-content affangrid">
            <div class="col-full">
               ...
               <?
				...
				?>
                	<img src="<?=base_url();?>images/fol.png" class="img-stylep" />
                    <h3 style="color:#999">This Campaign is now Public.</h3>
               <?
				}
				?>
				...
				if($row['status'] == 3){
				?>
                	<img src="<?=base_url();?>images/chabi.png" class="img-stylep" />
                    <h3 style="color:#999">This Campaign is now Private! It will not show in the main Polipad Public list.</h3>
               <?
				}
				?>
                 </div>
        ...
        <div class="wrap-content affangrid">
            <div class="col-full">
                <div class="block03"> 
                 <?
				if($isadmin == '1' and $row['status'] == 1){
				?>
                <a href="<? echo site_url('admin/publish/'.$cam_id);?>"> <img src="<?=base_url();?>images/publish.jpg" border="0" class="img-style3" /></a>
                <? }elseif($isadmin == '2' and $row['status'] != 2){ ?>
                <a href="<? echo site_url('candidate/core/'.$cam_id);?>"> <img src="<?=base_url();?>images/edit_more.png" border="0" class="img-style3" /></a>
                <? } ?>
                <?
				if($row['status'] == 0 || $row['status'] == 3){
				?>
                <a href="<? echo site_url('candidate/camsubmitconfirm');?>"><img src="<?=base_url();?>images/submit_big.png" class="img-style3" /></a>
                <? } ?>
               <?
	...
	<div class="wrap-content affangrid">
		<div class="row block00">
          ...
          <div class="col-3-4">
					...
					if($cb->num_rows() > 0)
					{
						if(($cbrow['cam_pic'] !='') or ($cbrow['cam_video'] !='')){
							?>
                             <div class="block05">
                            <?
						if($cbrow['cam_pic'] !=''){
                   ...
                   <?
					...
					?>
                         <div class="block05">
                        <div class="inner-block-round">
                            <h2 style="color:#002060">Why me?</h2>
							<?=$cwyrow['why_you']?>
                            </div> 
                            </div> 
                   <?
             ...
             <div class="col-1-4">
			  <div class="block06">
				...
				?>
					...
					<span style="color:#404040; font-size:14px; font-family:Arial, Helvetica, sans-serif; line-height:40px;">Supporters</span><span style="color:#404040; font-size:12px;  line-height:40px;">&nbsp;|&nbsp;<?=$visit->num_rows()?> Visitors</span><br /><br />


						
                    <h1 style="padding-top:8px; color:#77933C; font-size:62px;"><?=$totcom->num_rows()?></h1>
                    <h3 style="color:#404040; font-size:14px; font-family:Arial, Helvetica, sans-serif;">Feedbacks</h3><br />
