		...
		<div class="row block00">
          ...
          <div class="col-5-7">
             ...
             <div class="col-2-7">
              ...
              {
				  ?>
              <a href="<? echo site_url('campaign/main/'.$cam_id.'/0');?>" class="normallink" style="display: block; margin-left: auto; margin-right: auto;">Remove Stat Panel</a>
               <?
              }
              else
              {
				  ?>
              	<a href="<? echo site_url('campaign/main/'.$cam_id.'/1');?>" class="normallink" style="display: block; margin-left: auto; margin-right: auto;">Add Stat Panel </a>
                <?
              }
			   ?>
              </div>
