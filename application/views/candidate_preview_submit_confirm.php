     ...
     <div class="wrap-content affangrid">
            <div class="col-full">
                <div class="block03"> 
                	...
                	<img src="<?=base_url();?>images/prithibi.png" class="img-stylepq" />
                      <h3 style="color:#999;">Great! Congratulations in taking the big step towards going public with your campaign. You are just one step away...  Once you submit the campaign we will review it quickly and post it on our public board. We do this to avoid spam campaigns.</h3>
        ...
        <div class="wrap-content affangrid">
            <div class="col-full">
                ...
                <a href="<? echo site_url('candidate/camsubmit');?>"><img src="<?=base_url();?>images/okmake.png" class="img-style3" /></a>
